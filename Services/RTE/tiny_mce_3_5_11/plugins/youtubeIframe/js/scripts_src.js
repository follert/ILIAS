...
var YoutubeDialog = {
    ...
    insert: function () {
        ...
        <object width="'+width+'" height="'+height+'">\n\
            <param name="movie" value="https://www.youtube.com/v/'+code+'?version=3&amp;hl=en_US"></param>\n\
            <param name="allowFullScreen" value="true"></param>\n\
            <param name="allowscriptaccess" value="always"></param>\n\
            <param name="wmode" value="transparent"></param>\n\
            <embed src="https://www.youtube.com/v/'+code+'?version=3&amp;hl=en_US" type="application/x-shockwave-flash" width="'+width+'" height="'+height+'" allowscriptaccess="always" allowfullscreen="true"></embed>\n\
        </object>';
